...
class ProjectApiTest(unittest.TestCase):
    ...
    def test_owned_project_crud(self):
        created = self.client.post("/projects", json={"name": "Conference rehearsal", "goal": "Deliver the methods clearly"})
        ...
        updated = self.client.patch(f'/projects/{project["id"]}', json={"pinned": True, "deadline": "2026-12-01"})
