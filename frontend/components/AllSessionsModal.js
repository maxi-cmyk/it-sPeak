    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="sessions-dialog-title">
      ...
      <div className="modal-panel flex max-h-[80vh] max-w-lg flex-col p-0">
        <div className="flex items-center justify-between p-5 border-b border-zinc-800">
          <div><p className="page-kicker mb-1">Session history</p><h2 id="sessions-dialog-title" className="text-lg font-semibold text-zinc-50">Sessions</h2></div>
          <button onClick={onClose} className="icon-button -mr-2" aria-label="Close sessions">
