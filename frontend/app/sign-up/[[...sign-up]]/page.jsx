  ...
  return (
    <div className="app-shell grid min-h-screen place-items-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-6 text-center"><p className="page-kicker">Begin your baseline</p><h1 className="page-title">Create your it'sPEAK workspace</h1><p className="page-summary mx-auto">Build speaking readiness through focused, measurable rehearsals.</p></div>
