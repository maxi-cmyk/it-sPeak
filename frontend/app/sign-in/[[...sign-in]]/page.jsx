  ...
  return (
    <div className="app-shell grid min-h-screen place-items-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-6 text-center"><p className="page-kicker">Rehearsal control room</p><h1 className="page-title">Welcome back to it'sPEAK</h1><p className="page-summary mx-auto">Sign in to continue your retained rehearsal history.</p></div>
